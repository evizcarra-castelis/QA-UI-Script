...
WebUI.setText(findTestObject('Account Creation/Selector Registration/input_Professional_email'), ('qa.castelis.test' + String.valueOf(randomNumber)) + 
    '@yopmail.com')
...
WebUI.selectOptionByLabel(findTestObject('Account Creation/Selector Registration/select_Afghanistan                         _1506ee'), 'Philippines', 
    true)

WebUI.setText(findTestObject('Account Creation/Selector Registration/input_City_city'), 'Manila')

WebUI.selectOptionByIndex(findTestObject('Account Creation/Selector Registration/select_Additives, Ingredients, Raw Material_00aab6'), 19, 
    FailureHandling.STOP_ON_FAILURE)

WebUI.selectOptionByIndex(findTestObject('Account Creation/Selector Registration/select_RD - Basic Research                 _12afba'), 13, FailureHandling.STOP_ON_FAILURE)
